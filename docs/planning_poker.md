...
| ID     | Feature                                                                       | Estimations initiales | Estimation finale | Hypothèses / Remarques | Assigné à |
| **F1** | Bootstrap stack (Docker Compose, scripts, santé)                              | 3,5,3                 | 3                 |    Installation standard, attention à la version de Docker Desktop sur Mac.                    |  Sofiane        |
